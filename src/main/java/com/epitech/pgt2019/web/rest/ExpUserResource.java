...
public class ExpUserResource {
     ...
     */
    @PostMapping("/exp-users")
    public ResponseEntity<ExpUserDTO> createExpUser(@RequestBody ExpUserDTO expUserDTO) throws URISyntaxException {
        ...
        ExpUserDTO result = expUserService.save(expUserDTO);
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/exp-users")
    public ResponseEntity<ExpUserDTO> updateExpUser(@RequestBody ExpUserDTO expUserDTO) throws URISyntaxException {
